export default {
  ...
  forgotPasswordSub: 'Đặt mật khẩu mới rồi xác minh tài khoản bằng Google.',
  otpSkipStatus: 'Skip OTP: ON (bởi quản trị viên)',
  googleVerificationRequired: 'Vẫn cần Google xác minh đúng chủ tài khoản.',
  ...
  signUpSub: 'Dùng Google để xác minh email và tạo tài khoản DreamScape.',
